...
<h1 id="specific-provisioner-micro-service">Terraform Specific Provisioner API</h1>

Scroll down for code samples, example requests and responses.

Base URLs:

* <a href="/datamesh.specificprovisioner/{{version}}">/datamesh.specificprovisioner/{{version}}</a>
...
curl -X POST /datamesh.specificprovisioner/{{version}}/provision \
...
fetch('/datamesh.specificprovisioner/{{version}}/provision',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
```javaURL obj = new URL("/datamesh.specificprovisioner/{{version}}/provision");
...
r = requests.post('/datamesh.specificprovisioner/{{version}}/provision', headers = headers)
...
```shell
# You can also use wget
curl -X GET /datamesh.specificprovisioner/{{version}}/provision/{token}/status \
  -H 'Accept: application/json'
...
fetch('/datamesh.specificprovisioner/{{version}}/provision/{token}/status',
{
  method: 'GET',
...
```java
URL obj = new URL("/datamesh.specificprovisioner/{{version}}/provision/{token}/status");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
...
r = requests.get('/datamesh.specificprovisioner/{{version}}/provision/{token}/status', headers = headers)
...
```shell
# You can also use wget
curl -X POST /datamesh.specificprovisioner/{{version}}/validate \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
fetch('/datamesh.specificprovisioner/{{version}}/validate',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
```java
URL obj = new URL("/datamesh.specificprovisioner/{{version}}/validate");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
r = requests.post('/datamesh.specificprovisioner/{{version}}/validate', headers = headers)
...
```shell
# You can also use wget
curl -X POST /datamesh.specificprovisioner/{{version}}/unprovision \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
fetch('/datamesh.specificprovisioner/{{version}}/unprovision',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
```javaURL obj = new URL("/datamesh.specificprovisioner/{{version}}/unprovision");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
r = requests.post('/datamesh.specificprovisioner/{{version}}/unprovision', headers = headers)
...
```shell
# You can also use wget
curl -X POST /datamesh.specificprovisioner/{{version}}/updateacl \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json'
...
fetch('/datamesh.specificprovisioner/{{version}}/updateacl',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
```java
URL obj = new URL("/datamesh.specificprovisioner/{{version}}/updateacl");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("POST");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
r = requests.post('/datamesh.specificprovisioner/{{version}}/updateacl', headers = headers)
